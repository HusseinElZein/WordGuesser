...
class BuildWordList() {
    fun getWordList(): List<Word> {
        return listOf(
            ...
            Word("Superhero", "theflash"),
            Word("Superhero", "theamazingspiderman"),
            Word("Superhero", "superman"),
            Word("Superhero", "batman"),
            Word("Superhero", "wonderwoman"),
            Word("Superhero", "captainamerica"),
            Word("Superhero", "batman"),
